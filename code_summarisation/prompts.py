...
## Notable Error Handling — retry logic, dead-letter handling, alternate paths.
...
(Key Business Logic is still required; write the generic no-logic sentence if none is present.)
